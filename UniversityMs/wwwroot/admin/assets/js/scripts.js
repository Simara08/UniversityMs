...
! function(p, u) {
    ...
    p.ClassBody = function() {
        ...
        p.TGL.screen(n), t.on("click", function(t) {
            ...
            var e, n, a, i, o;
            s && (e = u(s), n = u(s).data("target"), n = u('[data-content="'.concat(n, '"]')), a = u(".select2-container"), i = u(".datepicker-dropdown"), o = u(".ui-timepicker-container"), e.is(t.target) || 0 !== e.has(t.target).length || n.is(t.target) || 0 !== n.has(t.target).length || a.is(t.target) || 0 !== a.has(t.target).length || i.is(t.target) || 0 !== i.has(t.target).length || o.is(t.target) || 0 !== o.has(t.target).length || (p.Toggle.removed(e.data("target"), r), s = !1))
        }), c.on("resize", function() {
            n.each(function() {
        ...
        u(a).exists() && u(a).each(function() {
            var t = (t = u(a).data("max-files")) || null,
                e = (e = u(a).data("max-file-size")) || 256,
