        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResearchProject_SectionCourseStruc_CourseSectionId",
                        column: x => x.CourseSectionId,
                        principalTable: "SectionCourseStruc",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ResearchProject_Faculty_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "Faculty",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RProjectPaper_ResearchProject_RProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(nullable: false),
                    DocLogsId = table.Column<int>(nullable: false),
                    ClassId = table.Column<int>(nullable: false),
                    TranskriptId = table.Column<int>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RProjectUser_ResearchProject_ResearchProjeckId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResearchProject_CourseSectionId",
                table: "ResearchProject",
                column: "CourseSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_ResearchProject_FacultyId",
                table: "ResearchProject",
                column: "FacultyId");
